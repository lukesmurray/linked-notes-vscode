...
import { getLocatorsFromCSLLocale } from "./getLocatorsFromCSLLocale";
const enUSLocaleXML = `<?xml version="1.0" encoding="utf-8"?>
...
suite("test locator extraction", () => {
  test("extracts the expected locales", () => {
    ...
    assert.deepStrictEqual(getLocatorsFromCSLLocale(enUSLocaleXML), [
      ...
      { locatorName: "figure", single: "figure", multiple: "figures" },
      { locatorName: "folio", single: "folio", multiple: "folios" },
      { locatorName: "issue", single: "number", multiple: "numbers" },
      { locatorName: "line", single: "line", multiple: "lines" },
